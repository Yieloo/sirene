...
do
  ...
  mongoimport -d sirene-geocode -c companies --type csv --file geo-sirene_${liste_departement[$i]}.csv --fieldFile /home/ubuntu/sirene/geocoding/header/header.csv --columnsHaveTypes
done
