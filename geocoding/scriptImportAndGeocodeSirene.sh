...
do
  ...
  mongoimport -d sirene-geocode -c companies --type csv --file $1/geo-sirene_${liste_departement[$i]}.csv --fieldFile ../header/header.csv --columnsHaveTypes --ignoreBlanks
done
